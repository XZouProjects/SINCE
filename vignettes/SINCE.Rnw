...
<<a1>>=
library(SINCE)
url = "https://raw.githubusercontent.com/XZouProjects/SINCE_test/master/SC3_Pollen_test.xls"
download.file(url, "SC3_Pollen_test.xls")
@

The clustering result directories are listed in the file named ``cluster\_res\_list\_test.txt``
<<a3>>=
url = "https://raw.githubusercontent.com/XZouProjects/SINCE_test/master/cluster_res_list_test.txt"
download.file(url,"cluster_res_list_test.txt")
@

<<a4>>=
url = "https://raw.githubusercontent.com/XZouProjects/SINCE_test/master/data_test.rda"
download.file(url, "data_test.rda")
load("data_test.rda")
@

SINCE analysis
<<a2>>=
CERS <- SINCE(data = data_test, cluster_res_list = "cluster_res_list_test.txt", paralSize = 4)
@
% ---------------------------------------------------------------------------
